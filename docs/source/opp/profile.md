...
:::{list-table} 1 – Загальна iнформацiя
:widths: 10 20
...
:::{list-table} 2 – Мета освiтньої програми
:widths: 30
...
:::{list-table} 3 - Характеристика освiтньої програми
:widths: 10 20
...
:::{list-table} 4 – Придатнiсть випускникiв до працевлаштування та подальшого навчання
:widths: 10 20
...
:::{list-table} 5 – Викладання та оцiнювання
:widths: 10 20
...
:::{list-table} 6 – Програмнi компетентностi
:widths: 10 20
...
:::{list-table} 7 – Програмнi результати навчання
:widths: 30
